...
console.log('Written fileDuplicator.js');

// Quick syntax check
require('d:/uni-bc/src/utils/fileDuplicator');
console.log('Syntax OK');

// Simulate a backup call to show log output
const { duplicateTopographySiteFile } = require('d:/uni-bc/src/utils/fileDuplicator');
console.log('\n=== Sample log output for TOPOGRAPHY SURVEY data file ===');
duplicateTopographySiteFile(
    '/app/storage/client_master/00012/site_master/00012-0015-JETPER (MORBI)/data/survey_points.csv',
    'TOPOGRAPHY SURVEY',
    'data'
);
console.log('\n=== Sample log output for VISIT schedule (should be SKIPPED) ===');
duplicateTopographySiteFile(
    '/app/storage/client_master/00012/site_master/00012-0015-JETPER (MORBI)/photos/photo.jpg',
    'VISIT',
    null
);
console.log('\n=== Sample log output for photo category (should be SKIPPED) ===');
duplicateTopographySiteFile(
    '/app/storage/client_master/00012/site_master/00012-0015-JETPER (MORBI)/photos/photo.jpg',
    'TOPOGRAPHY SURVEY',
    null
